...
contract CounterTest is Test {
    ...
    function testReaperHack() public {
        ...
        console.log(
            "account1 :",
            reaper.balanceOf(0x954773dD09a0bd708D3C03A62FB0947e8078fCf9) / 1e18
        );
        console.log(
            "account2 :",
            reaper.balanceOf(0xB573f01f2901c0dB3E14Ec80C6E12e4868DEC864) / 1e18
        );
        console.log(
            "account3 :",
            reaper.balanceOf(0xfc83DA727034a487f031dA33D55b4664ba312f1D) / 1e18
        );
        console.log(
            "account4 :",
            reaper.balanceOf(0xEB7a12fE169C98748EB20CE8286EAcCF4876643b) / 1e18
        );
